...
# Example: Clipping Vector Data with `GeoPandas`
...
lincoln_park.boundary.plot(ax=ax2, color=COLORS['red'])
lincoln_park.plot(ax=ax2, color=COLORS['green'], alpha=0.3)
# west_town.plot(ax=ax2, color=COLORS['green'], alpha=0.3)
chicago.plot(ax=ax1, alpha=0.4)
chicago.boundary.plot(ax=ax2, color=COLORS['grey060'], linewidth=0.6, zorder=-1)
groceries.plot(ax=ax2, color=COLORS['blue'], zorder=1, marker='.', alpha=0.66)
...
groceries_west_side.plot(ax=ax, color='C2')
...
fig, ax = plt.subplots(figsize=(14,6))
groceries_logan_square.plot(ax=ax, color='C2')
chicago.boundary.plot(ax=ax, color=COLORS['grey060'], linewidth=0.6, zorder=-1)
...
- Reference: [GeoPandas: Clip Vector Data](https://geopandas.org/en/stable/gallery/plot_clip.html)
